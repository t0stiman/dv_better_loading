# Immersive Cargo Loading

Derail Valley mod that overhauls the process of (un)loading cargo to make it more realistic.

## Installation

1. Install Unity Mod Manager(UMM).
2. Download this mods zip from the [releases](https://github.com/t0stiman/dv_better_loading/releases) page and drag-drop it into UMM.
